...
namespace MergeIt.Game.Configs.Services
{
    public class ConfigsService : IConfigsService
    {
        ...
        {
            _configsContainer = await GameModule.Resource.LoadAssetAsync<ConfigsContainer>(ConfigsConstants.ConfigsPath);//Resources.LoadAsync<ConfigsContainer>(ConfigsConstants.ConfigsPath);
