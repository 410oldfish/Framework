...
namespace MergeIt.Game.Field.Actions
{
    public class FieldGenerationProcessor : FieldActionProcessorBase
    {
        ...
        public override void ProcessClick(FieldCellComponent cellComponent)
        {
            ...
            if (cellComponent.FieldElementPresenter != null && cellComponent.FieldElementPresenter.IsSanded())
            {
                return;
            }
            ...
            */
            ...
            GridPoint? freePoint = _gameFieldService.GetFreeCell(fieldElement.InfoParameters.LogicPosition);
            ...
            if (generatorParameters.AvailableToDrop > 0)
            {
                ...
                _userServiceModel.Energy.Value -= Mathf.Max(0, generatorSettings.EnergyCost);
