...
namespace MergeIt.Game.UI.InventoryPanel
{
    public class InventoryPanelComponent : MonoBehaviour
    {
        ...
        private async UniTaskVoid CreateItem(IFieldElement fieldElement)
        {
            InventoryPanelItemComponent component = await _inventoryFactory.CreateInventoryPanelItem(fieldElement);
