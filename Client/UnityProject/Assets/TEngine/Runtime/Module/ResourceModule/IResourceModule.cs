...
namespace TEngine
{
    ...
    public interface IResourceModule
    {
        ...
        UniTask<T[]> LoadAssetAsyncByTag<T>(string tag, CancellationToken cancellationToken = default, string packageName = "") where T : UnityEngine.Object;
        ...
        /// <param name="location">资源的定位地址</param>
        UniTask<TObject> LoadSubAssetsAsync<TObject>(string location, string subAssetsName) where TObject : UnityEngine.Object;
